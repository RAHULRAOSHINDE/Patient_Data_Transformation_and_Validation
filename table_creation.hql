...
LINES TERMINATED BY '\n'
STORED AS TEXTFILE
LOCATION '/user/PDTV/source'
;

--The loading of data from patient.txt file is from local directory,

LOAD DATA LOCAL INPATH '/root/Desktop/PDTV/Dataset/patient.txt' INTO TABLE patient;
...
LINES TERMINATED BY '\n'
STORED AS TEXTFILE
LOCATION '/user/PDTV/target';

LOAD DATA LOCAL INPATH '/root/Desktop/PDTV/Dataset/patient_target.txt' INTO TABLE patients_target; 
